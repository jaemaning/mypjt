...
def vote_average_movies():
  ...
  url = "https://api.themoviedb.org/3/movie/popular?api_key=fe0cd3ae385a968eaa140d8955cf4804&language=ko-KR&page=1"
  response = requests.get(url).json()['results']

  # 결과 저장할 리스트
  result = []

  # 받아온 인기영화 정보에서 vote_average 값이 8 이상인 값만 result에 append
